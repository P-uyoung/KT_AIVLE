...
SELECT ADDTIME('2023-12-25 09:00:00', '01:30:40'); -- 2023-12-25 10:30:40
...
SELECT SUBDATE('2023-12-25 09:00:00', INTERVAL 15 DAY); -- 2023-12-10 09:00:00


-- 26) CURDATE() - 현재 날짜 확인

SELECT CURDATE(); -- 2023-11-13


-- 27) CURTIME() - 현재 시간 확인

SELECT CURTIME(); -- 14:30:17


-- 28) NOW() - 현재 날짜와 시간 확인

SELECT NOW(); -- 2023-11-13 14:30:30


-- 29) SYSDATE() - 현재 날짜와 시간 확인

SELECT SYSDATE(); -- 2023-11-13 14:30:38
...
SELECT DATE(NOW()); -- 2023-11-13


-- 35) TIME() -- 지정한 날짜와 시간에서 시간 확인 (SQLite, 사용 방법이 조금 다름)

SELECT TIME(NOW()); -- 14:31:13


-- 36) DATEDIFF() - 두 날짜와 시간의 일수 차이 확인

SELECT DATEDIFF('2023-12-25 00:00:00', NOW()); -- 42
...
SELECT DATE_FORMAT(NOW(), '%Y-%m-%d'); -- 2023-11-13
SELECT DATE_FORMAT(NOW(), '%Y.%m.%d'); -- 2023.11.13
SELECT DATE_FORMAT(NOW(), '%/%m/%d'); -- 2023/11/13
SELECT DATE_FORMAT(NOW(), '%Y%m%d'); -- 20231113
SELECT DATE_FORMAT(NOW(), '%Y년%m월%d일'); -- 2023년11월13일
